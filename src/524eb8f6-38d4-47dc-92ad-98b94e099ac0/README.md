...
class Insert << (F,LightGreen) >> #RoyalBlue {
  # array $historyGuid
  # array $insertids
  + insertids(bool $reset = false) : array
  ...
  # setInsertIds(int $rowsInserted) : void
  # trackHistory(string $table) : void
}

note right of Insert::insertids
...
note right of Insert::setInsertIds
