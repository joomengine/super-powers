### JCB! Power
# interface MessageInterface (Details)
> namespace: **VDM\Joomla\Interfaces\Import**

```uml
@startuml

interface MessageInterface  #Lavender {
  + get() : object
  + reset() : void
...
note right of MessageInterface::get
...
note right of MessageInterface::reset
...
note right of MessageInterface::addSuccess
...
note right of MessageInterface::addInfo
...
note right of MessageInterface::addError
...
> Simply use this SPK:
```
Super---578f428a_71f1_4187_bb8d_82e275c82a67---Power
```
