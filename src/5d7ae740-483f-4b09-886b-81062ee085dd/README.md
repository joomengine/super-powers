### JCB! Power
# trait IdentityTrait (Details)
> namespace: **VDM\Joomla\Componentbuilder\User**

```uml
@startuml

class IdentityTrait << (T,Orange) >> #Turquoise {
  # getIdentity() : User
}

note right of IdentityTrait::getIdentity
...
> Simply use this SPK:
```
Super---5d7ae740_483f_4b09_886b_81062ee085dd---Power
```
